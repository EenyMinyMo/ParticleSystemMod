...
public abstract class AbstractCylindricalParticle extends AbstractParticleSimpleData {
    ...
    public AbstractCylindricalParticle(float x, float y, float z, int maxLifeTime, AtlasIcon icon) {
        super(x, y, z, maxLifeTime, icon);
    }

    public AbstractCylindricalParticle(Vector3f position, int maxLifeTime, AtlasIcon icon) {
