 ...
 * Объекты подклассов этого интерфейса для использования нужно добавлять в объекты, производные от IParticleContainer,
 * подобно отдельным частицам.
 */
public interface IParticleEmitter {
     ...
     * В параметры передает контейнер частий, в который будут помещаться созданные эмиттером частицы.
     */
    void create(IParticleContainer container);
